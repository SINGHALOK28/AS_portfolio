            ...
            >
              <div>
                ...
                <div className="h-32 mb-4 bg-gradient-to-br from-emerald/10 to-cyan-glow/5 border border-cyan-glow/10 rounded-lg flex items-center justify-center relative overflow-hidden group-hover:border-cyan-glow/30 transition-colors">
                  ...
                  {proj.featured && (
                    <span className="absolute top-2 left-2 font-pixel text-[8px] text-purple-glow flex items-center gap-1 z-10">
              ...
              <div className="border-t border-cyan-glow/10 pt-4 flex items-center justify-between">
                ...
                <button className="flex items-center space-x-1 font-pixel text-[8px] text-cyan-glow uppercase tracking-wider group-hover:translate-x-1 transition-transform">
          ...
          {selectedProject && (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
              ...
              >
                ...
                <div className="p-6 bg-[#070b0c] border-t border-cyan-glow/10 flex justify-between items-center">
                  <a
                    href={selectedProject.github}
                    target="_blank"
                    rel="noreferrer"
                    onClick={playClickSound}
                    className="inline-flex items-center space-x-2 px-5 py-2.5 border border-cyan-glow/40 hover:border-cyan-glow hover:bg-cyan-glow/10 font-mono text-sm font-semibold tracking-wider text-cyan-glow transition-colors rounded-lg"
                  >
                  ...
                  <a
                    ...
                    rel="noreferrer"
                    onClick={playClickSound}
                    className="inline-flex items-center space-x-2 px-5 py-2.5 bg-cyan-glow text-black font-pixel text-[10px] tracking-wider transition-colors hover:bg-white rounded-lg"
                  >
